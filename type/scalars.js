...
exports.GraphQLJson = exports.GraphQLID = exports.GraphQLBoolean = exports.GraphQLString = exports.GraphQLFloat = exports.GraphQLInt = undefined;
...
var astToJson = {};
astToJson[_language.Kind.INT] = function (ast) {
  return GraphQLInt.parseLiteral(ast);
};
astToJson[_language.Kind.FLOAT] = function (ast) {
  return GraphQLFloat.parseLiteral(ast);
};
astToJson[_language.Kind.BOOLEAN] = function (ast) {
  return GraphQLBoolean.parseLiteral(ast);
};
astToJson[_language.Kind.STRING] = function (ast) {
  return GraphQLString.parseLiteral(ast);
};
astToJson[_language.Kind.ENUM] = function (ast) {
  return String(ast.value);
};
astToJson[_language.Kind.LIST] = function (ast) {
  return ast.values.map(function (astItem) {
    return GraphQLJson.parseLiteral(astItem);
  });
};
astToJson[_language.Kind.OBJECT] = function (ast) {
  var obj = {};
...
var GraphQLJson = exports.GraphQLJson = new _definition.GraphQLScalarType({
  name: 'JSON',
